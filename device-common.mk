...
PRODUCT_COPY_FILES += \
    ...
    $(TARGET_COPY_OUT_VENDOR)/etc/fstab.virtio.gsi.sda:$(TARGET_COPY_OUT_RAMDISK)/fstab.virtio.gsi.sda \
    $(TARGET_COPY_OUT_VENDOR)/etc/fstab.virtio.gsi.vdc:$(TARGET_COPY_OUT_RAMDISK)/fstab.virtio.gsi.vdc
