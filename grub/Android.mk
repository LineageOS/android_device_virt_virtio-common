...
$(INSTALLED_ISOIMAGE_TARGET): $(INSTALLED_ISOIMAGE_TARGET_DEPS)
	...
	$(PATH_OVERRIDE) $(GRUB_PREBUILT_DIR)/bin/grub-mkrescue -d $(GRUB_PREBUILT_DIR)/lib/grub/$(TARGET_GRUB_ARCH) --xorriso=$(XORRISO_EXEC) -o $(INSTALLED_ISOIMAGE_TARGET) $(INSTALLED_ISOIMAGE_TARGET_DEPS) $(WORKDIR)
