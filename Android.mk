...
define process-bootmgr-cfg-common
	...
	sed -i "s|@STRIPPED_TARGET_BOOTMGR_KERNEL_CMDLINE_UTM@|$(strip $(TARGET_BOOTMGR_KERNEL_CMDLINE_UTM))|g" $(1)
	sed -i "s|@STRIPPED_TARGET_BOOTMGR_KERNEL_CMDLINE_VIRTIO@|$(strip $(TARGET_BOOTMGR_KERNEL_CMDLINE_VIRTIO))|g" $(1)
endef
